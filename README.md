...
Работает елси поля названы непосредственно в коде, если там выражения для поддержки мультиязычности то выйдут эти выражения
Полностью базируется на внутреннем механизме reflection самой платформы lsfusoin
